...
class ListItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create list_item" do
    assert_difference('ListItem.count') do
      post list_items_url, params: { list_item: { description: @list_item.description, is_done: @list_item.is_done, list_id: @list_item.list_id, title: @list_item.title } }, as: :json
    end
  ...
  test "should update list_item" do
    patch list_item_url(@list_item), params: { list_item: { description: @list_item.description, is_done: @list_item.is_done, list_id: @list_item.list_id, title: @list_item.title } }, as: :json
    assert_response 200
  end
